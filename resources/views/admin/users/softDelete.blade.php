        ...
        <div class="min-height-200px">
            <div class="row clearfix">
                @if (!empty($users[0]))
                            ...
                            <div class="da-card">
                                ...
                                <div class="da-card-content">
                                    ...
                                    <div style="justify-content: center;display: flex">
                                        <a class="btn btn-outline-primary" href="{{ route('backend.users.restore', $user->id) }}"><i class="fas fa-redo"></i></a>
                    ...
                    @endforeach
                @else
                    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30" style="width: 100%; text-align: center">
