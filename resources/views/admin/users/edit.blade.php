        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
            <form method="POST" action="{{ route('backend.users.update', $user->id) }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="text" placeholder="Nhập tên" value="{{ $user->name }}"
                        name="name">
                </div>
                <div class="preview-upload">
                    <img id='sp_hinh-upload' src="{{ $user->image }}" />
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <label>Email</label>
                    <input class="form-control" value="{{ $user->email }}" type="email" placeholder="abc@gmail.com"
                        name="email">
                </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control" type="number" value="{{ $user->UserInfo->phone }}"
                        placeholder="Số điện thoại" name="phone">
                </div>

                <div class="form-group">
                    <label>Địa chỉ</label>
                    <input class="form-control" type="text" value="{{ $user->UserInfo->address }}"
